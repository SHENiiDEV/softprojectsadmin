...
class MyWork extends Component
{
    ...
    public function updatedFilterStatus(): void   { $this->loadTasks(); }
    public function updatedFilterPriority(): void { $this->loadTasks(); }
    public function updatedSearch(): void         { $this->loadTasks(); }
