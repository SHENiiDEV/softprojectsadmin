...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('vendor/jspreadsheet/jspreadsheet.css') }}" type="text/css" />
        <link rel="stylesheet" href="{{ asset('vendor/jsuites/jsuites.css') }}" type="text/css" />
        <script src="{{ asset('vendor/jsuites/jsuites.js') }}"></script>
        <script src="{{ asset('vendor/jspreadsheet/jspreadsheet.js') }}"></script>
