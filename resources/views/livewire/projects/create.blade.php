<div class="space-y-6">
    ...
    <div class="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800/60">
        <div>
            <h1 class="font-outfit font-extrabold text-2xl text-slate-800 dark:text-white tracking-tight">New Company</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Fill in the details of the company and the assigned director.</p>
        </div>
        <div>
            ...
            <div class="space-y-6">
                <div class="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 rounded-2xl p-6 shadow-sm space-y-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <!-- Fee Paid Status -->
                        <div>
                            <label class="block text-xs font-semibold uppercase tracking-wider text-slate-400 dark:text-slate-500 mb-2">Fee Payment Status</label>
                        ...
                        <!-- Director Managed By -->
                        <div>
                            <label class="block text-xs font-semibold uppercase tracking-wider text-slate-400 dark:text-slate-500 mb-2">Curator / Manager</label>
